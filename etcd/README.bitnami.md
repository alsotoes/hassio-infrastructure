...
Same-ish [README.md](https://github.com/bitnami/containers/blob/main/bitnami/etcd/README.md) minor changes to links and images to point the oficial bitnami/etcd repo.
